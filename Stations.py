...
class LocationConcat(beam.DoFn):
    ...
    def process(self, element):
        ...
        return [{'empty_slots':item['empty_slots'],
                 ...
                 '%_lleno':item['free_bikes']/total,
                 '%_vacío':item['empty_slots']/total
                 }]
...
def run(argv=None, save_main_session=True):
  ...
  parser.add_argument('--input_topic',
                      ...
                      default='projects/hackaton-superlopez/topics/valenbisi',
  ...
  parser.add_argument('--input_subscription',
                      ...
                      default='projects/hackaton-superlopez/subscriptions/streaming',
